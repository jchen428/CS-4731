...
from apspnavigator import APSP
from apspnavigator import findPath
...
if __name__ == "__main__":
	a = APSPRunner(dic2Nodes(locations), dic2Network(locations, romania))
	a.run()